...
module.exports = function (options) {
  var express = require('express'),
      ...
      controllers = new Controllers(options.directory, logger, options.indexDocument, options.errorDocument, options.fs, options.routingRules),
      path = require('path'),
      https = require('https'),
  ...
  app.post('/:bucket', controllers.bucketExists, upload.single('file'), controllers.postObject);
